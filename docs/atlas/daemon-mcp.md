...
A current `xurgo-atlas` daemon should advertise its supported tools through live `tools/list`. In the current `v0.4.0` repository line, that public tool set includes:
