...
A current `xurgo-atlas` daemon should advertise its supported tools through live `tools/list`. In the local `v0.5.0` release-candidate repository line, that public tool set includes:
